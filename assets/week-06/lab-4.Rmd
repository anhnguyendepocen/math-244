...
**Challenge problem**: Using the code available in the slides titled `qda.Rmd`, construct an ROC curve for your logistic regression model. For an extra challenge, plot the ROC curves of all three models on the same plot.
