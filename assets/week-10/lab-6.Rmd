...
). Next, fit a second random forest model that uses $m = p/3$. Compute their test MSEs based on the test data set here:
...
How much improvement do we get by using the random forests mechanism? Does it out-perform your regression model?
